...
interface DetectorCheckingProps {
  readonly documentTitle: string;
}

const STEPS = [
  { id: "tokenize", label: "Tokenizing text" },
  { id: "perplexity", label: "Measuring perplexity & burstiness" },
  { id: "stylometry", label: "Extracting stylometric features" },
  { id: "ensemble", label: "Running ensemble classifier" },
  { id: "sentence", label: "Scoring sentences" },
  { id: "calibrate", label: "Calibrating confidence" },
] as const;

const STEP_DURATION_MS = 600;

export function DetectorChecking({ documentTitle }: DetectorCheckingProps) {
  ...
  return (
    <Card className="flex flex-col gap-6">
      <div className="flex flex-col gap-1">
        <h1 className="text-h2 font-semibold text-fg">Analyzing text…</h1>
